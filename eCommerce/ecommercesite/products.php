...
<body>
    ...
    ?>
    <div class="container-xl mt-5 d-flex flex-wrap justify-content-between">
        <?php
            ...
            echo <<<product
                <div class="card mb-4 ">
                    <div class="card-body text-center">
                        <img src="../bootstrapmorph/undraw_cat_s1wg.svg" alt="cat" class="image-thumbnail border-1" width="200">
