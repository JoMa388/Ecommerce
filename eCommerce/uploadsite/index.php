...
<body class="bg-dark">
  ...
  <div class="d-flex flex-column justify-content-center align-items-center">
    <h1 class=" text-center text-light mt-5">&#128008; Store</h1>
    <?php
    ...
    <div class="container p-0">
      <table class="table table-hover text-center bg-light rounded">
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        echo <<<product
              <tr class="align-middle">
                ...
                <td>$$row[price]</td>
                <td>
                  <a href='includes/update.php?edit=$row[pid]'> <button type="button" class="btn btn-sm">Edit</button> </a>
    ...
    <div class="modal" id="addproduct">
      <div class="modal-dialog">
        <!-- Form -->
        <form action="includes/product.php" method="post">
  ...
  <script>
    function confirm_delete(id) {
      if (confirm("Are you sure you want to delete this product?")) {
        window.location.href = "includes/product.php?delete=" + id;
      }
    }
  </script>
</body>
